# Vendored from VitaCabinet (github.com/bayraktartahsin/vitacabinet), Apache-2.0,
# by the same author. Copied on 2026-09-05 with the module name adjusted; logic unchanged.
# Kept as a copy, not a dependency, so the judges can read every line that touches a medicine.
